...
export const LOAD_AUCTIONS_FAILURE = "LOAD_AUCTIONS_FAILURE";
...
export const FOLLOW_AUCTION_SUCCESS = "FOLLOW_AUCTION_SUCCESS";
export const FOLLOW_AUCTION_FAILURE = "FOLLOW_AUCTION_FAILURE";
export const UNFOLLOW_AUCTION_SUCCESS = "UNFOLLOW_AUCTION_SUCCESS";
export const UNFOLLOW_AUCTION_FAILURE = "UNFOLLOW_AUCTION_FAILURE";
